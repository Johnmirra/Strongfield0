...
public class Machinegun : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        damage = GameMechanics.Mechanics.MachinegunDamage;
        upgradeDamage = GameMechanics.Mechanics.MachinegunUpgradeDamage;
        upgradeRadius = GameMechanics.Mechanics.MachinegunUpgradeRadius;
        RestatusStats();
    }
    ...
    void Fire()
    {
        if (timeToShut < 0)
        {
            ...
            if (GameMechanics.Mechanics.turretsFR)
                timeToShut = GameMechanics.Mechanics.MachinegunReloatTime * GameMechanics.Mechanics.BonusTurretFR;
            else
                timeToShut = GameMechanics.Mechanics.MachinegunReloatTime;
            ...
            if (GameMechanics.Mechanics.damage)
                targeting.target.SendMessage("TakeDamage", damage + GameMechanics.Mechanics.BonusDamageToMachinegun);
            else
